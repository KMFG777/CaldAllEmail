...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'cald-secret-key-12345' # Change this in production
...
if __name__ == '__main__':
    with app.app_context():
        ...
        os.makedirs(app.config['UPLOAD_FOLDER'], exist_ok=True)
        # lightweight migration for message.sender_name
        try:
            ...
            pass
        # ensure project table ready for future flags (no destructive change)
        try:
